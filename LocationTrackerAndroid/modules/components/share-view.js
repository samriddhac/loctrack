...
export default class ShareView extends Component {
	...
	componentWillReceiveProps(nextProps) {
		this.setState({visible:nextProps.showshare});
	}

	render() {
		let shareOptions = {
			title: "WhereApp, Realtime Location Sharing App",
			message: "Download WhereApp to request and share your location with your friends.",
			url: "https://play.google.com/store/apps/details?id=com.locationtrackerandroid&hl=en",
			subject: "Download WhereApp, Realtime Location Sharing App"
		};
	              ...
	              setTimeout(() => {
	                if(typeof shareOptions["url"] !== undefined) {
	                  ...
	                  if (Platform.OS === "android") {
	                    ToastAndroid.show('WhereApp play store link is copied.', ToastAndroid.SHORT);
	                  }
	                }
	              },300);
	            }}>Copy Link</Button>
